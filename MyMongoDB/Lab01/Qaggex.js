...
print("-- Q11. 사원 테이블에서 커미션이 책정되지 않은 사원의 인원수 출력하라.");
...
print("-- Q12. 월급이 5000 이상 사원의 직업별 월급 합계 ");
...
print("-- Q13. 직업별 월급의 합을 구하고, 월급의 합이 3000 이하인 직업만 출력해보자.  ");
